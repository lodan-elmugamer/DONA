...
cat("Create virtual environment inside CellPhoneDb folder, adjust the file paths in run_cellchat.R, and run with bash ./run_cellphonedb.sh before running downstream_results.R.\n")
